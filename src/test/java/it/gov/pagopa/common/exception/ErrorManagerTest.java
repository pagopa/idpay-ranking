...
class ErrorManagerTest {
  ...
  void handleExceptionClientExceptionWithBody() throws Exception {
    Mockito.doThrow(new ClientExceptionWithBody(HttpStatus.BAD_REQUEST,  String.valueOf(HttpStatus.BAD_REQUEST.value()),"Error ClientExceptionWithBody"))
            .when(testControllerSpy).testEndpoint();
    ...
    Mockito.doThrow(new ClientExceptionWithBody(HttpStatus.BAD_REQUEST, String.valueOf(HttpStatus.BAD_REQUEST.value()),"Error ClientExceptionWithBody", new Exception()))
            .when(testControllerSpy).testEndpoint();
