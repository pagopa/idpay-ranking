...
import static it.gov.pagopa.ranking.constants.RankingConstants.REJECTION_REASON_CITIZEN_OUT_OF_RANKING;
...
public class OnboardingRankingRequest2EvaluationMapper {
    ...
    public EvaluationRankingDTO apply(OnboardingRankingRequests onboardingRankingRequests, InitiativeConfig initiative) {
        ...
        evaluationRankingDTO.setBeneficiaryBudgetCents(initiative.getBeneficiaryInitiativeBudgetCents());
